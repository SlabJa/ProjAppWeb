...
echo '<h1 class="heading" style="text-align:center; font-size: 32px;">Panel CMS</h1>';

echo '
<div class="admin-menu">
    <h3 style="display:inline;">Podstrony: </h3>
    <a href="admin.php">[Lista]</a> |
    <a href="admin.php?add=1">[Dodaj]</a> 
    <br><br>
    <h3 style="display:inline;">Sklep: </h3>
    <a href="admin.php?pokaz_sklep=1">[Kategorie]</a>
    <span style="float:right"><a href="admin.php?logout=1">[Wyloguj]</a></span>
</div>
<hr>';
...
// Sprawdzenie czy użytkownik chce wykonać jakąś akcję związaną ze sklepem
if (isset($_GET['pokaz_sklep']) || isset($_GET['edytuj_kat']) || isset($_GET['usun_kat']) || isset($_POST['dodaj_kat']) || isset($_POST['zapisz_kat'])) {
    
    echo '<h2 class="heading">Zarządzanie Sklepem</h2>';
